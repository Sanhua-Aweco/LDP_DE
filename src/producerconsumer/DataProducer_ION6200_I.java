 ...
 * @author User
 */
public class DataProducer_ION6200_I implements Runnable {
    ...
    private final String[] array_ION6200_I = {"23", "31", "46", "0D"};

    private byte[] bytes_ION6200_I;
    ...
    public DataProducer_ION6200_I(DataIOServer dataIOServer, BlockingQueue<Message> dataQueue) {
    ...
    public void run() {
        while (keepRunning()) {
            Message msg = new Message(bytes_ION6200_I, Data_ION6200_I);
            try {
                dataQueue.put(msg);
    ...
    private void initMessage() {
        bytes_ION6200_I = new byte[array_ION6200_I.length];
        messageCreator.setFillBytes(array_ION6200_I, bytes_ION6200_I);
    }
}
